...
var ListsResolver = /** @class */ (function () {
    function ListsResolver(useService, router, alertify) {
    ...
    ListsResolver.prototype.resolve = function (route) {
        var _this = this;
        return this.useService.getUsers(this.pageNumber, this.pageSize, null, this.likesParam).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (error) {
...
var MemberDetailResolver = /** @class */ (function () {
    function MemberDetailResolver(useService, router, alertify) {
        this.useService = useService;
        this.router = router;
        this.alertify = alertify;
    }
    MemberDetailResolver.prototype.resolve = function (route) {
        var _this = this;
        return this.useService.getUser(route.params['id']).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (error) {
            _this.alertify.error('Problem retrieving data');
...
var MemberEditResolver = /** @class */ (function () {
    function MemberEditResolver(useService, authService, router, alertify) {
        this.useService = useService;
        this.authService = authService;
        this.router = router;
        this.alertify = alertify;
    ...
    MemberEditResolver.prototype.resolve = function (route) {
        var _this = this;
        return this.useService.getUser(this.authService.decodedToken.nameid).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (error) {
...
var MemberListResolver = /** @class */ (function () {
    function MemberListResolver(useService, router, alertify) {
        this.useService = useService;
        this.router = router;
        this.alertify = alertify;
        this.pageNumber = 1;
    ...
    MemberListResolver.prototype.resolve = function (route) {
        var _this = this;
        return this.useService.getUsers(this.pageNumber, this.pageSize).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (error) {
            _this.alertify.error('Problem retrieving data');
            _this.router.navigate(['/home']);
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(null);
        }));
...
var MessagesResolver = /** @class */ (function () {
    function MessagesResolver(useService, router, alertify, authService) {
        this.useService = useService;
        this.router = router;
        this.alertify = alertify;
        this.authService = authService;
    ...
    MessagesResolver.prototype.resolve = function (route) {
        var _this = this;
        return this.useService.getMessages(this.authService.decodedToken.nameid, this.pageNumber, this.pageSize, this.messageContainer).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (error) {
...
var MemberDetailComponent = /** @class */ (function () {
    ...
    MemberDetailComponent.prototype.ngOnInit = function () {
        ...
        this.route.queryParams.subscribe(function (params) {
            ...
            _this.membersTabs.tabs[selectedTab > 0 ? selectedTab : 0].active = true;
        });
        this.galleryOptions = [
            {
                width: '500px',
    ...
    ], MemberDetailComponent.prototype, "membersTabs", void 0);
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.createRegisterForm = function () {
        this.registerForm = this.fb.group({
            ...
            password: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].minLength(6), _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].maxLength(8)]],
...
module.exports = __webpack_require__(/*! D:\Practice\DatingApp\DatingApp-SPA\src\main.ts */"./src/main.ts");
